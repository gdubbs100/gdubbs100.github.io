...
and $Z$ is a normalising constant and $\lambda$ is a temperature parameter. Larger values of $\lambda$ result in a closer to uniform weighting. This weighting is derived from the information theoretic objectives of the MPPI algorithm [3].
